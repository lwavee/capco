...
<footer style="background: var(--bg-primary); padding: 80px 0 40px; border-top: 1px solid var(--glass-border);">
    <div class="container">
        <div class="footer-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 4rem; margin-bottom: 50px;">
            ...
            <div>
                <h4 style="margin-bottom: 1.5rem; text-transform: uppercase; font-size: 0.9rem;">Newsletter</h4>
                <p style="color: var(--text-secondary); font-size: 0.85rem; margin-bottom: 1rem;">Stay updated with industry news and coverage tips.</p>
                <div style="display: flex; gap: 0.5rem;">
                    <input type="email" placeholder="Email" style="flex: 1; padding: 0.8rem; background: var(--bg-secondary); border: 1px solid var(--glass-border); color: white; border-radius: 4px; border: none; outline: none;">
                    <button class="btn-quote" style="padding: 0 1rem; border: none; cursor: pointer; border-radius: 4px;">Go</button>
                </div>
            </div>
        </div>
        <div style="padding-top: 40px; border-top: 1px solid var(--glass-border); text-align: center; color: var(--text-secondary); font-size: 0.8rem;">
            <p>© 2026 Capital & Co Insurance Services. Agency License #6002332. All rights reserved.</p>
        </div>
    </div>
</footer>
`;
